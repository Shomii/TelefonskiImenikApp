...
<html>
    ...
    <body>
    <center>
        <h2 style="color: white;">Vaš e-mail je poslat administratorima. </h2>
        <br/>
        <h2 style="color: white;">Hvala što nam pomažete da unapredimo uslugu </h2>
        <br/><br/><br/><br/>

        <div style="width: 350px;height: 50px;position: absolute;margin-left: 41%;">
            <input action="action" class="btn btn-primary btn-block btn-large" value="Vrati se na telefonski imenik"  type="button" onclick="location.href = 'telefonskiImenik'" />   
        </div> 
    </center>
</body>
</html>